...
const formats: Format[] = [
  { id: 'json', name: 'JSON 형식', description: '나중에 불러오기 가능' },
  { id: 'html', name: 'HTML 형식', description: '웹 브라우저에서 보기' },
]
...
function ResumeEditor({ data, onDownload, onSave, onLoad, autoSaveDirectory }: Props) {
  ...
  useEffect(() => {
    setSaveDirectory(autoSaveDirectory)
  }, [autoSaveDirectory])
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* 컨텐츠 */}
      <div className="max-w-[2400px] mx-auto px-8 py-8 flex gap-8">
        {/* 편집 영역 */}
        <div className="flex-1 space-y-8">
          ...
          {/* 교육 및 활동 */}
          <section className="bg-white rounded-xl shadow p-6">
            <h2 className="text-xl font-bold text-gray-900 mb-6">교육 및 활동</h2>
            <EducationEditor
        ...
        {/* 미리보기 영역 */}
        <div className="flex-1 sticky top-8 h-[calc(100vh-8rem)] overflow-auto">
